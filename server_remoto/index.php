  ...
  <div class="dashboard-grid">
    ...
    <div class="card border-temp <?php echo getTempClass($safeTemp0); ?>">
      <a href="grafico.php?var=temperatura">
        ...
        <div class="card-value"><?php echo ($safeTemp0 <= -99 ? '--' : $safeTemp0); ?><span class="card-unit">°C</span>
        </div>
        <div class="minmax-row">
          <div class="minmax-item"><span class="minmax-label">Min</span><span
              class="minmax-val val-min"><?php echo $mm_min_temp; ?>°</span></div>
          <div class="minmax-item"><span
              class="minmax-label">Trend</span><?php echo getTrendHtml($trend_temp1, '°C/h', $iceTime_temp1); ?></div>
          <div class="minmax-item"><span class="minmax-label">Max</span><span
              class="minmax-val val-max"><?php echo $mm_max_temp; ?>°</span></div>
        </div>
      </a>
    </div>
    ...
    <div class="card border-pres">
      <a href="grafico.php?var=press">
        ...
        <?php elseif ($forecast['icon'] == 'snow'): ?>
          <svg viewBox="0 0 24 24" class="card-icon" style="color:var(--accent-ice)" fill="none" stroke="currentColor"
        ...
        <div
          style="font-weight:800; font-size: 0.75rem; color:<?php echo $forecast['color']; ?>; margin-top:5px; text-transform:uppercase;">
        ...
        <div class="minmax-row">
          <div class="minmax-item"><span class="minmax-label">Liv. Mare</span><span
              class="minmax-val"><?php echo number_format($mslp, 1); ?></span></div>
          <div class="minmax-item"><span class="minmax-label">Trend 3h</span><span
              class="minmax-val <?php echo ($presTrendValid ? ($presTrend3h < 0 ? 'trend-down' : 'trend-up') : ''); ?>"><?php echo $presTrendValid ? (($presTrend3h > 0 ? '+' : '') . number_format($presTrend3h, 1)) : 'n/d'; ?></span>
          </div>
        </div>
      </a>
    </div>
    ...
    <div class="card border-power <?php echo getPowerClass((float) $pvValue); ?>">
      <a href="<?php echo $pvLink; ?>">
        ...
        <?php if ($skyNow !== null): ?>
          <div
            style="font-weight:800; font-size:0.75rem; color:<?php echo $skyNow['color']; ?>; margin-top:5px; text-transform:uppercase;">
    ...
    <div class="card border-humi">
      <a href="grafico.php?var=hombra">
        ...
        <div class="minmax-row">
          <div class="minmax-item"><span class="minmax-label">Range 24h</span><span
              class="minmax-val"><?php echo $mm_min_humi; ?>% - <?php echo $mm_max_humi; ?>%</span></div>
        </div>
      </a>
    </div>
    ...
    <div class="card border-water <?php echo ($waterStatus == 'dry' ? 'river-dry' : ''); ?>">
      <a href="grafico.php?var=portata">
        <?php if ($waterStatus == 'dry'): ?>
          <svg viewBox="0 0 24 24" class="card-icon" style="color:var(--accent-dry)" fill="currentColor">
        ...
        <?php else: ?>
          <svg viewBox="0 0 24 24" class="card-icon" style="color:var(--accent-blue)" fill="currentColor">
            ...
            <?php if ($waterStatus == 'increasing' && $trend_piave > 1.5): ?>
              <path d="M12 2l-4 4h8l-4-4z" style="color:var(--accent-red)" /><?php endif; ?>
          </svg>
        <?php endif; ?>
        ...
        <div
          style="font-weight:800; font-size:0.8rem; margin-top:5px; text-transform:uppercase; color:<?php echo ($waterStatus == 'dry' ? 'var(--accent-dry)' : ($waterStatus == 'increasing' ? 'var(--accent-red)' : 'var(--accent-blue)')); ?>;">
          <?php echo ($waterStatus == 'dry' ? 'Secca' : ($waterStatus == 'increasing' ? 'In Piena' : 'Normale')); ?>
        </div>
        <div class="minmax-row">
          <div class="minmax-item"><span class="minmax-label">Trend
              Orario</span><?php echo getTrendHtml($trend_piave, 'm³/s/h'); ?></div>
        </div>
      </a>
    </div>
